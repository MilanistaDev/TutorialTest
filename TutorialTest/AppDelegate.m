...
//  TutorialTest
//
//  Created by 麻生 拓弥 on 2014/10/23.
//  Copyright (c) 2014年 Takuya Aso. All rights reserved.
//

#import "AppDelegate.h"
// チュートリアルを実装するViewController のヘッダファイルを記述
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    if ([[NSUserDefaults standardUserDefaults] boolForKey:@"HasLaunchedOnce"]) {
        ...
        TutorialViewController* vc = [TutorialSB instantiateViewControllerWithIdentifier: @"TutorialViewController"];
        // その画面を表示させる
